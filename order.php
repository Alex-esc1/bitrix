...
if(intval($filter_created_by)>0) $arFilter["CREATED_BY"] = intval($filter_created_by);
...
$arHeaders = array(
	...
	array("id"=>"CREATED_BY","content"=>'Кем создан', "sort"=>""),
);
	...
	<form name="find_form" method="GET" action="<?echo $APPLICATION->GetCurPage()?>?">
		...
		<tr>
			...
			<td>
				...
				<?echo FindUserID("filter_created_by", $filter_created_by, "", "find_form");?>
			</td>
		</tr>
